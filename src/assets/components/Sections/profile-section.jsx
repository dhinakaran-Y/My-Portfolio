...
const ProfileSection = () => {
  ...
  return (
    <div
      className={`${`xl:justify-self-center xl:w-5xl xl:flex xl:flex-row xl:my-20 xl:space-x-40`} ${`lg:justify-self-center lg:mx-auto lg:items-center lg:flex lg:flex-row lg:mb-5 lg:my-15 lg:space-x-30`} overflow-hidden ${`sm:mx-5 sm:mb-10 sm:flex-col sm:space-x-0`} ${`max-sm:mx-5 max-sm:mb-10 max-sm:flex-col max-sm:space-x-0`}`}
      id="profileSection">
      <div
        ...
        <img
          className={`${`lg:w-64`} ${`xl:w-70`} object-cover rounded-full border-5 hover:scale-95 transition-all duration-300 border-custom-green  p-1 flex-none ${`sm:w-60 sm:mx-auto`} ${`max-sm:w-60 max-sm:mx-auto`}`}
