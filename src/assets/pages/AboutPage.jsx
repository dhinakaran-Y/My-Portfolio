  ...
  const [visible , setVisible] = useState(false)  
    ...
    return (
      <div
        ...
        <div
          className={`font-sans ${`xl:mx-auto xl:text-[300px] xl:w-6xl`} ${`lg:mx-auto lg:text-[180px] lg:w-2xl`} font-extrabold ${`max-sm:text-[100px] max-sm:w-full max-sm:mx-3`} ${`sm:w-md sm:text-[125px] sm:mx-auto`} relative text-custom-green/20 transition-all duration-3000 transform ${
            visible
              ? "translate-x-0 opacity-100"
              : "-translate-x-100 opacity-20"
          }`}>
          ABOUT
          <div
